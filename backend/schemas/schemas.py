...
class QuizGenerateRequest(BaseModel):
    ...
    question_type:  str = Field(..., pattern="^(mcq|short_answer|mixed)$")
    content_focus:  str = Field("both", pattern="^(theoretical|practical|both)$")
    user_id:        int
...
class QuizResponse(BaseModel):
    ...
    difficulty:      str
    questions:       List[dict]
    # source_content intentionally omitted — due to large payload
